      ...
      <DocumentTitle title={this.getPageTitle()}>
        <div className={styles.container}>
          <div className={styles.containers}>
            <div className={styles.contents}><img src='http://pdum0jw3j.bkt.clouddn.com/backchart.png' /></div>
            <div className={styles.content}>
              <div className={styles.top}>
                <div className={styles.header}>
                  <Link to="/">
                    <img alt="logo" className={styles.logo} src='http://pdum0jw3j.bkt.clouddn.com/logoGreen.png' />
                  </Link>
                </div>
